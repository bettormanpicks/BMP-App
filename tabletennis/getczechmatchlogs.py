...
def append_to_csv(new_rows):
    ...
    if not os.path.exists("data/tt_czech_matchlogs.csv"):
        df_new.to_csv("data/tt_czech_matchlogs.csv", index=False)
    else:
        df_new.to_csv("data/tt_czech_matchlogs.csv", mode='a', header=False, index=False)

def resort_csv():
    if os.path.exists("data/tt_czech_matchlogs.csv"):
        ...
        df.to_csv("data/tt_czech_matchlogs.csv", index=False)
...
def main():
    ...
    if os.path.exists("data/tt_czech_matchlogs.csv"):
        existing_ids = set(pd.read_csv("data/tt_czech_matchlogs.csv")["match_id"].astype(str))
