            ...
            with st.spinner("Loading and processing data..."):
                ...
                for _, row in upcoming.iterrows():
                    ...
                    row_dict = {
                        ...
                        "D%": round(stats.get("deuce_pct", 0) * 100, 1) if stats.get("deuce_pct") is not None else "--",
                        "ASM": round(stats.get("avg_set_margin", 0), 2) if stats.get("avg_set_margin") is not None else "--",
                        "P1 BLR2%": fmt_pct(stats.get("a_blr2_pct") or 0, stats.get("a_blr2_n", 0)),
                        "P1 BLR2#": str(stats.get("a_blr2_n", 0)) if stats.get("a_blr2_n", 0) > 0 else "--",
                        "P1 BLR3%": fmt_pct(stats.get("a_blr3_pct") or 0, stats.get("a_blr3_n", 0)),
                        "P1 BLR3#": str(stats.get("a_blr3_n", 0)) if stats.get("a_blr3_n", 0) > 0 else "--",
                        "P2 BLR2%": fmt_pct(stats.get("b_blr2_pct") or 0, stats.get("b_blr2_n", 0)),
                        "P2 BLR2#": str(stats.get("b_blr2_n", 0)) if stats.get("b_blr2_n", 0) > 0 else "--",
                        "P2 BLR3%": fmt_pct(stats.get("b_blr3_pct") or 0, stats.get("b_blr3_n", 0)),
                        "P2 BLR3#": str(stats.get("b_blr3_n", 0)) if stats.get("b_blr3_n", 0) > 0 else "--",
