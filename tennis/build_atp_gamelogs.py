...
MATCH_FILE = os.path.join(DATA_DIR, "atp_match_logs.csv")
OUTPUT_FILE = os.path.join(DATA_DIR, "atp_player_gamelogs.csv")
...
for _, m in matches.iterrows():
    p1_id = get_atp_player_id(m["Winner"])
    p2_id = get_atp_player_id(m["Loser"])
